...
Filtro_Bra2 = Hotelroombra(:,["accommodates","availability_365","bathroom_text","bedrooms","beds","calculated_host_listings_count","host_acceptance_rate","host_listings_count","host_response_rate","maximum_nights","minimum_nights","number_of_reviews","number_of_reviews_ltm","price","reviews_per_month","review_scores_value","review_scores_rating","review_scores_location","review_scores_communication","review_scores_cleanliness","review_scores_checkin","review_scores_accuracy"]);

%---------Correlación de datos Bra2---------

%Matriz de correlaciones - Hotel room
Matriz2=table2array(Filtro_Bra2); %esta línea convierte la tabla en matriz
Mat_Corr2=corrcoef(Matriz2); %Matriz de correlaciones

%Crear mapa de calor
hm_bra2 = heatmap(Mat_Corr2);
